...
public class Student extends Person {
    ...
    private String[] courses; // courses codes
    private  int[] grades; // grade for the corresponding corses codes
    private static final int MAX_COURSES = 30; // maximum number of courses

    /** Constructors a Student instance with the given name and address */
