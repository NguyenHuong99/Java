...
public class Teacher extends Person {
    ...
    /** Constructors a Teacher instance with the given name and add address */
    ...
    public boolean addCourse(String course) {
        //Check if yhe course already in the course list
    ...
    /** Removes a course. Returns false if the course cannot be found in the course líst */
